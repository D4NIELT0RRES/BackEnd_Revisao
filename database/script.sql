...
drop database  db_lionbook_revisao;
...
CREATE TABLE tbl_livros (
    ...
    FOREIGN KEY (autor_id) REFERENCES tbl_autores(id),
...
CREATE TABLE tbl_estoque (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (livro_id) REFERENCES tbl_livros(id) ON DELETE CASCADE
);
...
CREATE TABLE tbl_movimentacoes_estoque (
    ...
    observacoes TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (livro_id) REFERENCES tbl_livros(id)
);
...
-- Autores
INSERT INTO tbl_autores (nome, biografia) VALUES
...
-- Livros
INSERT INTO tbl_livros (titulo, autor_id, categoria_id, isbn, preco, descricao, paginas, editora, ano_publicacao) VALUES
...
-- Estoque inicial
INSERT INTO tbl_estoque (livro_id, quantidade_atual, quantidade_minima, quantidade_maxima, localizacao) VALUES
...
INSERT INTO tbl_movimentacoes_estoque (livro_id, tipo_movimentacao, quantidade, motivo, observacoes) VALUES
